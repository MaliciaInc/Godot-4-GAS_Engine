## Aiming a 3D ray, for as long as somebody is aiming it.
##
...
class_name GameplayRaycastTargetProvider3D extends GameplayTargetProvider
...
func _aim() -> GameplayAbilityTargetData:
	...
	return GameplayTargetingService.raycast_3d(source_asc(), world, request)
