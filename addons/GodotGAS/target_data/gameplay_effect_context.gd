...
const Payload = preload("res://addons/GodotGAS/target_data/gameplay_effect_context_payload.gd")
const AbilityHandle = preload("res://addons/GodotGAS/abilities/gameplay_ability_handle.gd")
