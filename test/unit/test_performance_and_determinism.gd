...
const HEADER: String = (
	...
	+ "\n"
	+ "The passes each application made over every effect already running are\n"
	+ "gone as of F6.5: the stack search, the immunity check and the\n"
	+ "reevaluation a tag change causes each read a bucket now rather than the\n"
