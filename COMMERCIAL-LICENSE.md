...
- organization-wide development rights;
- negotiated support, maintenance, or update terms.

## What this file does not grant

This document is a description of the commercial licensing program. **It is not itself a license grant.**

No modification, derivative-development, or framework-redistribution rights are granted merely by reading, copying, cloning, forking, or possessing this repository.

Those rights become effective only when MaliciaInc and the licensee enter into a separate written Commercial Modification License agreement and any required licensing fee has been paid under that agreement.

## Commercial games do not automatically require this license
...
Contact **MaliciaInc**, the repository owner, through the contact method published on the MaliciaInc GitHub profile or repository documentation.

A commercial agreement should identify at minimum:

1. the individual or legal entity receiving the license;
2. the scope of permitted modifications;
3. whether modified source may remain private or be redistributed;
4. the products, projects, or organization covered;
5. any redistribution or sublicensing rights;
6. the license fee and payment terms;
7. support or maintenance terms, if any;
8. the duration and termination conditions of the commercial grant.

## Third-party material

A Commercial Modification License issued by MaliciaInc can grant only rights that MaliciaInc owns or is legally entitled to sublicense. Third-party material remains subject to its own applicable license terms and notices as identified in `THIRD_PARTY.md` or alongside that material.

---

**Community use:** free under `LICENSE`  
**Modification / derivative framework rights:** separate paid written license required
