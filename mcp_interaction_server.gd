...
# Patched for Arhalies_GAS: this project promotes the warnings below to
# errors, and an untyped injected script fails to parse before it can
# report anything about the file it was asked to check. Restore from
# mcp_interaction_server.gd.pre-strict-typing.bak to undo.
...
@warning_ignore_start("unsafe_void_return")
